...
export function AppHeader() {
  ...
  const finalLogo = logoUrl ?? "/avatars/logoRound.png"; // fallback
    ...
    <AppSectionContainer id="header">
      ...
      >
        <motion.header
          ...
          className="rounded-b-lg flex items-center justify-between h-16 max-w-7xl w-full border-b-2 border-white/30 dark:border-neutral-500/30 mx-auto px-4 sm:px-6 lg:px-8"
        >
